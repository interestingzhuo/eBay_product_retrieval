...
def basic_training_parameters(parser):
    ...
    parser.add_argument('--tau',               default=[20,30,35], nargs='+',type=int , help='Stepsize before reducing learning rate.')
...
def loss_specific_parameters(parser):
    ...
    ##relaxation
    parser.add_argument('--relax',             default='log_neg',  type=str, help='relaxation type.')
